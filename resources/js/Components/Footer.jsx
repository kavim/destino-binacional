export default function DangerButton() {
    return (
        <footer class="w-full text-gray-700 bg-stone-800 body-font mt-40">
            <div
                ...
                <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                    ...
                    <p class="mt-2 text-sm text-gray-100">Descubrí tu destino!</p>
                    <div class="mt-4">
                        <span class="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
                            <a class="text-gray-200 cursor-pointer hover:text-gray-100">
                                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    class="w-5 h-5" viewBox="0 0 24 24">
                                    <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                                </svg>
                            </a>
                            <a class="ml-3 text-gray-200 cursor-pointer hover:text-gray-100">
                                <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    class="w-5 h-5" viewBox="0 0 24 24">
                                    <path
                ...
                <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                    <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                        <h2 class="mb-3 text-sm font-medium tracking-widest text-gray-400 uppercase title-font">Contacto</h2>
                        <nav class="mb-10 list-none">
                            <li class="mt-3">
                                <a class="text-gray-200 cursor-pointer hover:text-gray-100">email@email.com</a>
                            </li>
                            <li class="mt-3">
                                <a class="text-gray-200 cursor-pointer hover:text-gray-100">email@email.com</a>
                            </li>
                            <li class="mt-3">
                                <a class="text-gray-200 cursor-pointer hover:text-gray-100">+123-456-7890</a>
                            </li>
                        </nav>
                    </div>
                </div>
            ...
            <div class="bg-stone-900">
                <div class="container px-5 py-4 mx-auto">
                    <p class="text-sm text-gray-100 capitalize xl:text-center">© 2020 All rights reserved | Developed by <a href='https://www.linkedin.com/in/kevin-maciel-medeiros-602b66159/'>Los Carpincho</a></p>
                </div>
            </div>
        </footer>
    );
