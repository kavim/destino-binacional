        ...
        <footer className="w-full text-gray-700 bg-stone-800 body-font mt-40">
                ...
                <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                    <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                        ...
                        <nav className="mb-10 list-none">
                            <li className="mt-3">
                                <a className="text-gray-200 cursor-pointer hover:text-gray-100">email@email.com</a>
                            </li>
                            <li className="mt-3">
                                <a className="text-gray-200 cursor-pointer hover:text-gray-100">email@email.com</a>
                            </li>
                            <li className="mt-3">
                                <a className="text-gray-200 cursor-pointer hover:text-gray-100">+123-456-7890</a>
                            </li>
                        </nav>
                    </div>
                </div>
            ...
            <div className="bg-stone-900">
                <div className="container px-5 py-4 mx-auto">
                    <p className="text-sm text-gray-100 capitalize xl:text-center">© 2020 All rights reserved | Developed by <a href='https://www.linkedin.com/in/kevin-maciel-medeiros-602b66159/'>Los Carpincho</a></p>
                </div>
            </div>
        </footer>
    );
