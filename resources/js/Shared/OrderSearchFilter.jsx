...
export default () => {
    ...
    return (
        <div className="flex items-center w-full max-w-md mr-4">
            <div className="relative flex w-full bg-white rounded-md shadow">
                <div style={{ top: '100%' }} className={`absolute ${opened ? '' : 'hidden'}`}>
                    ...
                    <div className="relative z-30 w-64 px-4 py-6 mt-2 bg-white rounded shadow-lg">
                        <SelectInput label="status" name="status" value={values.status} onChange={handleChange}>
                ...
                <button
                    ...
                    className="px-4 border-r rounded-l md:px-6 hover:bg-gray-100 focus:outline-none focus:border-white focus:ring-2 focus:ring-opacity-50 focus:ring-indigo-400 focus:z-10"
                >
                ...
                <input
                    className="relative w-full px-6 py-3 rounded-r-md focus:outline-none focus:ring-2 focus:ring-opacity-50 focus:ring-indigo-400 border-white focus:border-indigo-300"
                    ...
                    placeholder="Search for code or partner name"
                />
            </div>
            <button
                onClick={reset}
