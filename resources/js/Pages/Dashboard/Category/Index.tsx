        ...
        <AuthenticatedLayout header={
            ...
            <div className='py-12'>
                <div className="max-w-7xl mx-auto sm:px-2">
                    <div className="overflow-x-auto bg-card rounded-xl shadow mb-3 p-4">
                        {parent_categories.length > 0 ? (
                            parent_categories.map((pc, index) =>
                                <div key={index} className='bg-card p-3 rounded-lg mb-3 border shadow-sm'>
                                    <div>
                                        <div className='mb-4'>
                                                    ...
                                                    return (
                                                        <div key={index} className='px-2 py-1 border rounded-lg mb-2'>
                                                            <div className='flex justify-between items-center'>
                                                                ...
                                                                <div>
                                                                    <Link href={route('categories.edit', item.id)} className="btn btn-circle btn-outline btn-sm border-border text-muted-foreground"> <i className="fa-solid fa-pencil"></i> </Link>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    );
